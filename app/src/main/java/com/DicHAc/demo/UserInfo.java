...
public class UserInfo extends AppCompatActivity {
    private TextInputLayout layoutName,layoutLastname,layoutcin,layoutadress;
    private TextInputEditText txtName,txtLastname,txtadress,txtcin;
    ...
    private boolean validate(){
        ...
        if (txtLastname.getText().toString().isEmpty()){
            ...
            layoutLastname.setError("Num de téléphone est nécessaire!");
            return false;
        }
        if (txtcin.getText().toString().isEmpty()){
            layoutName.setErrorEnabled(true);
            layoutName.setError("CIN est nécessaire!");
            return false;
        }
        return true;
    }
    ...
    private void saveUserInfo(){
        ...
        String cin = txtcin.getText().toString().trim();
        String adresse = txtadress.getText().toString().trim();
